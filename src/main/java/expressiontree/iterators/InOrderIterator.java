...
public class InOrderIterator implements Iterator<ExpressionTree> {
     ...
     */
    private Stack<ExpressionTree> mParenStack = new Stack<>();

    /**
     * Keeps track of the right most number in a parenthesized
     * expression.
     */
    private Stack<ExpressionTree> mLastNodeStack = new Stack<>();
     ...
     */
    private void checkAndHandleLowerPrecedenceChild(ExpressionTree root, ExpressionTree child) {

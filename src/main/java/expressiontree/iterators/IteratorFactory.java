...
public class IteratorFactory {
    ...
    public Iterator<ExpressionTree> iterator(ExpressionTree tree, String traversalOrderRequest)
    {
        ...
        IteratorFactoryCommand command = mIteratorMap.get(traversalOrderRequest);
        ...
        if (command != null)
            ...
            // an exception.
            throw new IllegalArgumentException(traversalOrderRequest + " is not a supported traversal order");
    }
     ...
     */
    public static class LevelOrderIterator implements Iterator<ExpressionTree> {
        /**

...
public interface ComponentNode {
     ...
     */
    default int getType() {
        throw new UnsupportedOperationException("ComponentNode::type() called improperly");
    }
     ...
     */
    default int getItem() {
        throw new UnsupportedOperationException("ComponentNode::getItem() called improperly");
    }

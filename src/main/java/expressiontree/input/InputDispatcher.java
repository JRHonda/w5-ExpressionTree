...
public class InputDispatcher {
     ...
     */
    public void makeHandler(boolean verbose, Platform platform) {
        mInputHandler = InputHandler.makeHandler(verbose, platform);
    }
     ...
     */
    public void makeHandler(Platform platform, InputHandler inputHandler) {
     ...
     * @param platform Provides input and output according to the configured runtime platform.
     */
    public void makeHandlerAndPromptUser(boolean verbose, Platform platform) {
        mInputHandler = InputHandler.makeHandler(verbose, platform);

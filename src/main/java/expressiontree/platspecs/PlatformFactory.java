...
public class PlatformFactory {
     ...
     * implementation.
     */
    private HashMap<String, PlatformFactoryCommand> platformMap = new HashMap<>();
    ...
    public PlatformFactory(final Object input, final Object output, final Object activity) {
        ...
        platformMap.put("Sun Microsystems Inc.", () -> new CommandLinePlatform(input, output));

        // The "Oracle Corporation" string maps to a command object
        // that creates an @a CommandLinePlatform implementation.
        platformMap.put("Oracle Corporation", () -> new CommandLinePlatform(input, output));
    }

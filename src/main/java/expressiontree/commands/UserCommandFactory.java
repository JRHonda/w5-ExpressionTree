...
public class UserCommandFactory {
     ...
     */
    private HashMap<String, UserCommandFactoryCommand> commandMap = new HashMap<>();
    ...
    public UserCommandFactory(final TreeContext treeContext) {
        ...
        commandMap.put("quit", param -> new QuitCommand(treeContext));
    }
    ...
    public UserCommand makeUserCommand(String inputString) {
        ...
        UserCommandFactoryCommand command = commandMap.get(commandRequest);
